      ...
      class Repository
        class YumTest < ::ActiveSupport::TestCase
          ...
          def test_additional_content_hrefs_properly_includes_errata
            service = Katello::Pulp3::Repository::Yum.new(@repo, @proxy)
            rpm = ::Katello::Rpm.create(name: "foobar", filename: "foobar-1.3.4.rpm", nvra: "foobar-1.2.3", pulp_prn: "test")
            ...
            assert_includes(service.additional_content_hrefs(@repo, [rpm.pulp_prn], []), 'fedora_17_x86_64_security_href')
            refute_includes(service.additional_content_hrefs(@repo, [rpm.pulp_prn], []), 'rhel6_security_href')
          end
          ...
          def test_additional_content_hrefs_properly_excludes_errata
            ...
            ::Katello::Pulp3::Repository::Yum.any_instance.stubs(:metadatafiles).returns(nil)
            ::Katello::Pulp3::Repository::Yum.any_instance.stubs(:distributiontrees).returns(nil)
            refute_includes(service.additional_content_hrefs(@repo, [rpm.pulp_prn],
