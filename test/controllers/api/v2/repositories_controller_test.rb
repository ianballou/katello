...
module Katello
  class Api::V2::RepositoriesControllerTest < ActionController::TestCase
    ...
    def test_index_with_erratum_id
      ...
      response = get :index, params: { :erratum_id => @errata.pulp_prn, :organization_id => @organization.id }
    ...
    def test_remove_content
      ...
      put :remove_content, params: { :id => @repository.id, :ids => [@rpm.pulp_prn] }
    ...
    def test_remove_content_bad_type
      ...
      put :remove_content, params: { :id => @repository.id, :ids => [@rpm.pulp_prn], :content_type => 'cheese' }
